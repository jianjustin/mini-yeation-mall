package org.mini.yeation.mall.view.tag;
...
import org.mini.yeation.mall.utils.ColorUtils;
...
public class TagContainerLayout extends ViewGroup {
     ...
     */
    private int mTheme = ColorUtils.PURE_CYAN;
    ...
    private int[] onUpdateColorFactory() {
        int[] colors;
        if (mTheme == ColorUtils.RANDOM) {
            colors = ColorUtils.onRandomBuild();
        } else if (mTheme == ColorUtils.PURE_TEAL) {
            colors = ColorUtils.onPureBuild(ColorUtils.PURE_COLOR.TEAL);
        } else if (mTheme == ColorUtils.PURE_CYAN) {
            colors = ColorUtils.onPureBuild(ColorUtils.PURE_COLOR.CYAN);
        } else {
